...
class CatViewSet(viewsets.ModelViewSet):
    ...
    # pagination_class = None  # Так отключается
    ...
    # котиков теперь выдаём по 20 штук, остальные ресурсы — по пять объектов
    ...
    # можно искать по связанным моделям чере знак __
    # Определим, что значение параметра search должно быть
    # началом искомой строки - ^
